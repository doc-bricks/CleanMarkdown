...
def test_render_manifest_xml_validity():
    ...
    assert "Geiger.CleanMarkdown" in manifest_xml
    assert "CN=52596601-BAB4-4F3F-B182-E8F3F273B202" in manifest_xml


def test_generated_assets_exist():
    # Icons must exist
    for icon_name in ["icon_44x44.png", "icon_50x50.png", "icon_150x150.png", "icon_310x150.png", "icon_310x310.png", "SplashScreen.png"]:
